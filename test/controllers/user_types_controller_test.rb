...
class UserTypesControllerTest < ActionController::TestCase
  ...
  test "should create user_type" do
    assert_difference('UserType.count') do
      post :create, user_type: { deleted: @user_type.deleted, descripcion: @user_type.descripcion, nombre: @user_type.nombre }
    end
  ...
  test "should update user_type" do
    patch :update, id: @user_type, user_type: { deleted: @user_type.deleted, descripcion: @user_type.descripcion, nombre: @user_type.nombre }
    assert_redirected_to user_type_path(assigns(:user_type))
  end
